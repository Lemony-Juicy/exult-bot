      ...
      <div class="flex justify-between flex-col md:flex-row">
        ...
        <div id="navbar-links" class="mt-3 md:flex mr-10 flex-col md:flex-row hidden">
          ...
          <div class="dropdown inline-block relative">
            ...
            <ul class="dropdown-menu absolute hidden text-gray-700 pt-1">
              <li><a class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">Docs</a></li>
                <li><a class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">Support Server</a></li>
            </ul>
          </div> -->
          <a href="https://discord.gg/2gY2tGSjXW"><p class="text-white font-semibold mt-3 ml-3 mr-5">Join Our Discord</p></a>
